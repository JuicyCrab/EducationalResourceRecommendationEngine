...
class BM25Retriever(RetrieverUtils):
    def __int__(self, k1 = 1.5, b = 0.75):
        self.k1 = k1
        self.b = b
    ...
    def compute_idf(self, term: str) -> float:
        ...
        doc_freq = self.doc_term_freq.get(term, 0)
    ...
    def score_document(self, query: str, doc_id: int) -> float:
        ...
        for token in query_tokens:
            ...
            length_norm = 1 - self.b + self.b * (len(self.documents[doc_id]) / self.avg_doc_len)
    ...
    def search(self, query: str, top_k: int = 5) -> list[tuple[int, float]]:
        ...
        candidates = set()
        for token in query_tokens:
            candidates.update(self.inverted_index.get(token, 0))
